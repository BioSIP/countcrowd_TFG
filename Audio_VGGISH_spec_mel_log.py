...
SAVE_FILENAME = 'vggish_melspectrogram_mselog.pickle'
...
class MelSpectrogramDataset(Dataset):
	...
	def __getitem__(self, idx):
		...
		x = torchaudio.transforms.MelScale(n_mels = 201, sample_rate = sample_rate)(spec)
...
trainset = MelSpectrogramDataset(audio_path, train_density_path,'MEL')
valset = MelSpectrogramDataset(audio_path, val_density_path,'MEL')
testset = MelSpectrogramDataset(audio_path, test_density_path,'MEL')
...
expcode = 'vggish_melspectrogram_mselog'

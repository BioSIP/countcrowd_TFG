...
SAVE_FILENAME = 'crisnet_melspectrogram.pickle'
...
trainset = MelSpectrogramDataset(audio_path, train_density_path)
valset = MelSpectrogramDataset(audio_path, val_density_path)
testset = MelSpectrogramDataset(audio_path, test_density_path)
...
expcode = 'crisnet_melspectrogram'
